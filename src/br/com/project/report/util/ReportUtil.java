...
public class ReportUtil implements Serializable {
	...
	public StreamedContent geraRelatorio(List<?> listDataBeanColletionReport, HashMap parametrosRelatorio, 
		...
		/*
		 Fornece o caminho fisico até a pasta que contem os relatorios compilados .jasper
		 */
		...
		/*Remove o arquivo do servidor após ser feito o download pelo ususario*/
		arquivoGerado.deleteOnExit();
		
		/*Cria o inpuitStream para ser usado pelo primefaces*/
